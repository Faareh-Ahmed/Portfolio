                        ...
                        <div className="w-full md:w-1/2 xl:w-1/3 px-4 mb-8">
                            <div className=" rounded-lg overflow-hidden mb-10 bg-background h-full transform hover:scale-105 transition-transform ">
                                ...
                                <div className="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
                                    <h3>
                                        <a href="javascript:void(0)" className="font-semibold text-foreground text-xl sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px] mb-4 block hover:text-primary " >
                                            The Flags
                                        </a>
                                    </h3>
